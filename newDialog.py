...
from adddialog import Ui_Dialog as adddialo

class Dialog(QDialog, adddialo):
    def __init__(self):
    ...
    def setfont(self):
        ...
        self.labeltemp.setFont(self.font2)
    ...
    def handleprocess(self):
        ...
        self.lPatientName.textChanged.connect(self.handle)
    ...
    def onrun(self):
        ...
        self.complet.setEnabled(False)
        self.trago.setEnabled(False)
    ...
    def handle(self):
        self.lPatientName.text() + self.flPatientName.text() + self.sPatientName.text() + self.fPatientName.text()
        if len(self.lPatientName.text() + self.flPatientName.text() + self.sPatientName.text() + self.fPatientName.text()) <3:
